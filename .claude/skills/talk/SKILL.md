...
- "Clean up the authentication module module"
```
...
Changes made to:
  - authentication module/src/tar_ball.cpp (removed)
  - authentication module/src/tar_ball.hpp (removed)
  - authentication module/src/tar_file.cpp (simplified)
