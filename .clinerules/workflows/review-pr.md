...
- Review both the code changes and the PR description
- Check CI status before approving
- Provide constructive, actionable feedback
- Use --body-file on Windows to avoid quoting issues
- Cannot self-approve PRs - use comment instead if you're the author
