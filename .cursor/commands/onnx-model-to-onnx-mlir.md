...
2. **Run the dump script yourself** (do not only print env vars):
   - gpu-bash: `bash ".cursor/skills/onnx-model-to-onnx-mlir/scripts/onnx-model-to-onnx-mlir.sh" <path-to-model.onnx>`
   - PowerShell: `& ".cursor/skills/onnx-model-to-onnx-mlir/scripts/onnx-model-to-onnx-mlir.ps1" <path-to-model.onnx>`
