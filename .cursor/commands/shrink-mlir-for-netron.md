...
2. **Run the combined pipeline yourself**:
   - gpu-bash: `bash ".cursor/skills/shrink-mlir-for-netron/scripts/shrink_mlir_for_netron.sh" <path.mlir>`
   - PowerShell: `& ".cursor/skills/shrink-mlir-for-netron/scripts/shrink_mlir_for_netron.ps1" <path.mlir>`
