...
- Design doc: `docs/design/op-state-registry.md` (see the As-Built section for the file map). Two related drafts (`inline-prepack-cache.md`, `workspace-improvements.md`) are marked superseded.
