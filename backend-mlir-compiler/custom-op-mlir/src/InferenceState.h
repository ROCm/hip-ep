...
public:
  ...
  // `provider_options` is the session's effective EP provider-option map. It is
  // handed to inference_init so the runtime can copy it into RuntimeState
  // before anything built there consults it.
