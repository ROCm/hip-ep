...
../../local/bin/udna-opt.exe tools/udna-opt/demos/demo_two_layer_conv.mlir --convert-onnx-to-hip > ../output/stage1_onnx_to_hip.mlir
# ... (all stages)
```
...
- ❌ `C:/Develop/m/local/bin/udna-opt.exe`
- ✅ `../../local/bin/udna-opt.exe`
