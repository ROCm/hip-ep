...
**Description:** Tests ONNX Runtime inference with **CPU provider only** (baseline for comparison with VitisAI EP/GPU).

**Note:** This test intentionally does NOT use VitisAI EP. It establishes a CPU baseline result 
that test #5 (`VitisAIProviderInference`) compares against to verify GPU correctness.
...
[I:onnxruntime:, inference_session.cc:2079] Adding default CPU execution provider.  <-- CPU only, NOT VitisAI EP
...
[I:onnxruntime:, pass_main.cpp:328] [ROCm EP Level-1] Starting ROCm pass
[I:onnxruntime:, pass_main.cpp:333] [ROCm EP Level-1] pass_generic_param: {"subPassNames":["morphizen-level2-pass-rocm-conv","morphizen-level2-pass-rocm-gemm"]}
[I:onnxruntime:, pass_main.cpp:349] [ROCm EP Level-1] Creating sub-pass: morphizen-level2-pass-rocm-conv
[I:onnxruntime:, pass_main.cpp:358] [ROCm EP Level-1] Running sub-pass: morphizen-level2-pass-rocm-conv
...
[I:onnxruntime:, pass_main.cpp:349] [ROCm EP Level-1] Creating sub-pass: morphizen-level2-pass-rocm-gemm
[I:onnxruntime:, pass_main.cpp:358] [ROCm EP Level-1] Running sub-pass: morphizen-level2-pass-rocm-gemm
[I:onnxruntime:, pass_main.cpp:89] [ROCm Gemm L2] Processing graph for Gemm patterns...
[I:onnxruntime:, pass_main.cpp:369] [ROCm EP Level-1] Completed - sub-passes handled fusion
...
**Source Files:**
- `test/test_gqa.cpp` - GQA layer test
- `test/test_timeout.cpp` - GPU timeout test
