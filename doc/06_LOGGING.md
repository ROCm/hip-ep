...
void Level1Rocm::process(IPass& self, Graph& graph) {
  ...
  MY_LOG(2) << "[ROCm EP Level-1] Detailed process info...";
...
```
2026-01-17 19:37:20.xxx [I:onnxruntime:, pass_main.cpp:xxx] [ROCm EP Level-1] Starting ROCm pass
2026-01-17 19:37:20.xxx [I:onnxruntime:, pass_main.cpp:xxx] [ROCm EP Level-1] pass_generic_param: {...}
...
3. **Prefix messages consistently:**
   - `[ROCm EP Level-1]` for Level-1 pass
   - `[ROCm EP Level-2 Conv]` for Conv pattern pass
