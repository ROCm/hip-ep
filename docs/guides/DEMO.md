...
udna-compile demo_two_layer_conv.mlir --from-onnx-mlir -o demo.dll
...
**Command:** `udna-opt <input> --<pass-name>`

**Example - Stage 1:**
```bash
udna-opt demo.mlir --convert-onnx-to-hip > stage1.mlir
```
...
│                                 └──────────────────────────────────┘
│                                                                     │
│  Note: udna-compiler.dll NOT needed at inference time    │
└─────────────────────────────────────────────────────────────────────┘
```
...
1. **Offline compilation:**
   - Compile on server with `udna-compiler.dll`
...
**Design details:** [RUNTIME-ARCHITECTURE.md](../design/RUNTIME-ARCHITECTURE.md), [INTERFACE-DESIGN.md](../design/mlir/INTERFACE-DESIGN.md)
...
- [ARCHITECTURE.md](../design/ARCHITECTURE.md) - Major design decisions with rationale
- [MLIR-COMPILATION-OVERVIEW.md](../design/MLIR-COMPILATION-OVERVIEW.md) - High-level pipeline
- [RUNTIME-ARCHITECTURE.md](../design/RUNTIME-ARCHITECTURE.md) - RuntimeState and IR merging
- [CONSTANT-HANDLING-DESIGN.md](../design/CONSTANT-HANDLING-DESIGN.md) - Registry pattern
- [INTERFACE-DESIGN.md](../design/mlir/INTERFACE-DESIGN.md) - C interface specification

**Pass Pipeline (9 docs):**
- [LOWERING-PIPELINE.md](../design/LOWERING-PIPELINE.md) - Complete 8-stage flow
- [02-OnnxToHip.md](../design/mlir/passes/02-OnnxToHip.md) through [06-GenerateInterfacePass.md](../design/mlir/passes/06-GenerateInterfacePass.md)
- [04a-MemoryPoolingAlgorithm.md](../design/mlir/passes/04a-MemoryPoolingAlgorithm.md) - Graph coloring details
- [WHY-HIP-WRAPPERS.md](../design/WHY-HIP-WRAPPERS.md) - Wrapper function rationale

**Optimization & Strategy (11 docs):**
- [02b-OneShotBufferize.md](../design/mlir/passes/02b-OneShotBufferize.md), [04-MemoryPooling.md](../design/mlir/passes/04-MemoryPooling.md)
- [NATIVE-VS-IR-COMPARISON.md](../design/NATIVE-VS-IR-COMPARISON.md) - DLL vs LLVM IR analysis
- [HIP-DIALECT-DESIGN.md](../design/HIP-DIALECT-DESIGN.md), [MEMORY-MANAGEMENT.md](../design/MEMORY-MANAGEMENT.md)
- And more...

Location: `3rd-party/morphizen/udna-compiler/doc/design/`
...
**Command:**
```bash
../../build/$(basename $PWD)/Debug/bin/udna-opt.exe \
  tools/udna-opt/demos/demo_two_layer_conv.mlir \
  --convert-onnx-to-hip \
  > ../output/stage1.mlir
```
...
**Design details:** [CONSTANT-HANDLING-DESIGN.md](../design/CONSTANT-HANDLING-DESIGN.md), [02-OnnxToHip.md](../design/mlir/passes/02-OnnxToHip.md), [02b-OneShotBufferize.md](../design/mlir/passes/02b-OneShotBufferize.md)
...
**Design details:** [02b-OneShotBufferize.md](../design/mlir/passes/02b-OneShotBufferize.md)
...
**Design details:** [04-MemoryPooling.md](../design/04-MemoryPooling.md)
...
Input: tools/udna-opt/demos/demo_two_layer_conv.mlir
...
../../build/$(basename $PWD)/Debug/bin/udna-opt.exe tools/udna-opt/demos/demo_two_layer_conv.mlir --convert-onnx-to-hip > ../output/stage1_onnx_to_hip.mlir
# ... (all stages)
```
...
- ❌ `C:/Develop/m/build/onnx-hipdnn-ep/Debug/bin/udna-opt.exe`
- ✅ `../../build/$(basename $PWD)/Debug/bin/udna-opt.exe`

**Rule 4: Make Commands Reproducible**
- Use `$(basename $PWD)` - works on any checkout
- Use `tools/udna-opt/demos/` - correct paths from project root
