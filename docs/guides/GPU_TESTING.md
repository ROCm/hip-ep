...
# Compile demo model
../../build/onnx-hipdnn-ep/Debug/bin/hip-compile.exe \
...
├── Debug/bin/hip-compile.exe              # Compiler tool (262MB)
...
1. **Build Verification** (no GPU needed):
   ...
   cmake --build ../../build/onnx-hipdnn-ep --target hip-compile

   # Verify DLL generation succeeds
   hip-compile test.mlir -o test.dll
