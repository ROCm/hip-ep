...
**File**: `mlir-compiler/tools/udna-compile/main.cpp`
...
udna-compile test/e2e/test_in_memory_dll.mlir \
...
- **Compiler Tool**: `mlir-compiler/tools/udna-compile/main.cpp`
...
### Phase 4: Integration
- [ ] Add `--mode in-memory-dll` option to udna-compile
