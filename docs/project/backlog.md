...
Active work tracked in GitHub PRs: `gh pr list --repo ROCm/UDNA-compiler`
...
|---|-------|-----|-----|-------|---------|-------|
| #017 | Route model.dll output through FileSystem; rename `--constants-dir` to `--output-dir` | H | 2h | Compiler/CLI/Tests | - | `CompilerDriver.cpp`, `udna-compile.cpp`, `udna-opt.cpp`, `CMakeLists.txt`, `lit/e2e/*.mlir`, `lit.site.cfg.py.in`, `lit.cfg.py` |
