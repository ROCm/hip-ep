...
```cmake
# Before:
set(TABLEGEN_OUTPUT_DIR ${CMAKE_BINARY_DIR}/include/hip-compiler/Dialect/Hip/IR)
...
```cmake
# Before:
# This allows headers to use #include "hip-compiler/Dialect/Hip/IR/HipDialect.h.inc"
