...
module {
  func.func @two_muls(
    ...
    hip.miopen.mul(%handle) ins(%A, %B : memref<1x4x4xf32, strided<[?, ?, ?], offset: ?>>, memref<1x4x4xf32, strided<[?, ?, ?], offset: ?>>) outs(%tmp : memref<1x4x4xf32>)
    hip.miopen.mul(%handle) ins(%tmp, %C : memref<1x4x4xf32>, memref<1x4x4xf32, strided<[?, ?, ?], offset: ?>>) outs(%D : memref<1x4x4xf32>)
