...
module {
  func.func @two_rms_norms(
    ...
    hip.miopen.rms_norm(%handle) ins(%A, %W0 : memref<1x4x8xf32, strided<[?, ?, ?], offset: ?>>, memref<8xf32, strided<[?], offset: ?>>) outs(%tmp : memref<1x4x8xf32>)
    hip.miopen.rms_norm(%handle) ins(%tmp, %W1 : memref<1x4x8xf32>, memref<8xf32, strided<[?], offset: ?>>) outs(%B : memref<1x4x8xf32>)
