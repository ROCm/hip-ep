//===- Passes.h - HIP compiler-driver pass declarations ------- *- C++ -*-===//
//
// Copyright (C) 2026 Advanced Micro Devices, Inc.  All rights reserved.
// Licensed under the MIT License.
//
//===----------------------------------------------------------------------===//
#ifndef HIP_COMPILER_PASSES_PASSES_H
#define HIP_COMPILER_PASSES_PASSES_H
...
#endif // HIP_COMPILER_PASSES_PASSES_H
