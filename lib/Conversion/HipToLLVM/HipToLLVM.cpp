...
private:
  ...
  //   main_graph  a thin wrapper the EP calls with (ctx, inputs), where inputs
  //     is a C array of pointers to memref descriptor structs. For each input
  //     it loads the descriptor and unpacks it back into the scalar fields
