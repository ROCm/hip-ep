...
void ConvertHipToLLVMPass::runOnOperation() {
  ...
  populateQDQMLIRLoweringPatterns(typeConverter, patterns);
  ...
  populateLstmLoweringPatterns(typeConverter, patterns);
  populateStftLoweringPatterns(typeConverter, patterns);
