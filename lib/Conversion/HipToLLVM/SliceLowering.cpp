...
//
// Today the runtime function is a stub that throws (see lib/Runtime/real/
// slice.cpp). This lowering exists to keep the IR pipeline (bufferize ->
// hip-to-llvm -> generate-interface) functional even when a Slice cannot be
// folded to tensor.extract_slice by the OnnxToHip decompose pattern.
