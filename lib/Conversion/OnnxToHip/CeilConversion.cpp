...
/// onnx.Ceil -> hip.ceil
/// Unary element-wise ceiling: Y = ceil(X). Float types.
struct CeilToHip : public mlir::RewritePattern {
  CeilToHip(mlir::MLIRContext *ctx)
      : RewritePattern("onnx.Ceil", /*benefit=*/1, ctx) {}
