 ...
 * GEMM), 1 = fp32. score_element_size_bytes selects the score-buffer dtype,
 * 2 (HIPDNN_EP_GQA_SCORE_FP16) or 4; a 2-byte score with an fp16 output is the
 * in-place case, which is safe. The bias is added before the column max. */
