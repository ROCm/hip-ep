...
static int onnx_type_to_udna_dtype(int64_t onnx_type) {
  switch (onnx_type) {
    case ONNX_FLOAT:   return UDNA_DTYPE_FLOAT32;
    case ONNX_INT32:   return UDNA_DTYPE_INT32;
    case ONNX_INT64:   return UDNA_DTYPE_INT64;
    case ONNX_FLOAT16: return UDNA_DTYPE_FLOAT16;
    default:           return -1;
  }
}
...
static int element_size_to_udna_dtype(int64_t elem_size) {
  switch (elem_size) {
    case 8: return UDNA_DTYPE_INT64;
    case 4: return UDNA_DTYPE_INT32;
    case 2: return UDNA_DTYPE_FLOAT16;
    default: return -1;
  }
}
...
int wrap_cast(RuntimeState* state, void* input, void* output,
  ...
  return udna_cast(stream, input, output, num_elements,
                   input_dtype, output_dtype);
}
