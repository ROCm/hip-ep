...
int try_mlss_conv_forward(RuntimeState *, int32_t, const void *, int64_t,
                          int64_t, int64_t, int64_t, const void *, int64_t,
...
int try_mlss_conv_forward(RuntimeState *state, int32_t op_state_slot,
                          const void *input, int64_t input_n, int64_t input_c,
                          int64_t input_h, int64_t input_w, const void *weights,
                          int64_t weights_k, const void *bias, void *output,
