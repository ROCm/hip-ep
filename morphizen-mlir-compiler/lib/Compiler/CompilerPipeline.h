...
#ifndef MORPHIZEN_MLIR_COMPILER_PIPELINE_H
#define MORPHIZEN_MLIR_COMPILER_PIPELINE_H
...
/**
 * Reusable compilation pipeline for MLIR → DLL/Object/IR.
 *
 * Extracts shared logic from mlir-hip-compiler tool.
 * Used by:
 * - mlir-hip-compiler (CLI tool)
 * - CInterface (DLL C API)
 * - level-1-pass (Morphizen plugin)
 */
...
#endif // MORPHIZEN_MLIR_COMPILER_PIPELINE_H
