...
#include "morphizen-mlir-compiler/Dialect/Hip/IR/HipDialect.cpp.inc"

void HipDialect::initialize() {
  addTypes<
#define GET_TYPEDEF_LIST
#include "morphizen-mlir-compiler/Dialect/Hip/IR/HipTypes.cpp.inc"
      >();
  addOperations<
#define GET_OP_LIST
#include "morphizen-mlir-compiler/Dialect/Hip/IR/HipOps.cpp.inc"
      >();
}
