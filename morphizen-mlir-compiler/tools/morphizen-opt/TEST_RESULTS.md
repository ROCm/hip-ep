...
- **morphizen-opt tool**: Builds without errors
...
**Command:**
```bash
morphizen-opt test.mlir --convert-hip-to-llvm
```
...
This is the standard way to use MLIR passes in production code. Command-line tools like morphizen-opt are primarily for development/debugging.
