...
using NodeAttributes =
    std::unordered_map<std::string, ONNX_NAMESPACE::AttributeProto>;
...
public:
  ...
  static ::onnxruntime::common::Status
  GetType(const ONNX_NAMESPACE::AttributeProto& attr, AttrType& type);
