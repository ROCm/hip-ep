...
inline std::vector<std::string> get_all_vaip_ort_api_functions() {
  return {
      ...
      // NodeArg APIs [34-45]
      "node_arg_get_name_unsafe", "node_arg_is_exists", "node_arg_is_constant",
      "node_arg_clone", "node_arg_new", "node_arg_get_shape_i64_unsafe",
      "node_arg_get_denotation_unsafe", "node_arg_set_shape_i64",
      "node_arg_set_denotation", "node_arg_get_element_type",
      "node_arg_set_element_type", "node_arg_get_const_data_as_tensor",
      ...
      "attr_proto_new_float", "attr_proto_new_string", "attr_proto_new_tensor",
      "attr_proto_new_ints", "attr_proto_new_floats", "attr_proto_new_strings",
      "attr_proto_get_int", "attr_proto_get_float", "attr_proto_get_string",
      "attr_proto_get_tensor", "attr_proto_get_ints", "attr_proto_get_floats",
      "attr_proto_get_strings",
      ...
      "tensor_proto_new_u64", "tensor_proto_new_fp16", "tensor_proto_new_bf16",
      "get_model_path", "create_empty_model", "graph_set_inputs",
      "node_arg_external_location", "session_option_configuration",
      "model_to_proto", "model_proto_serialize_as_string", "model_proto_delete",
