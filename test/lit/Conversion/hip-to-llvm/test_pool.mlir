...
// (state, input, output, indices, shape_valid, data_type, pool_mode,
//  spatial_rank, N, C,
...
module {
  ...
  func.func @maxpool_2d_static_f16(
    ...
    hip.pool(%ctx) valid(%valid) ins(%x : memref<1x3x32x32xf16, 1>)
  ...
  func.func @maxpool_2d_with_indices(
    ...
    hip.pool(%ctx) valid(%valid) ins(%x : memref<1x3x32x32xf32, 1>)
  ...
  func.func @maxpool_dynamic_n_f32(
    ...
    hip.pool(%ctx) valid(%valid) ins(%x : memref<?x3x16x16xf32, 1>)
  ...
  func.func @maxpool_1d_static_f32(
    ...
    hip.pool(%ctx) valid(%valid) ins(%x : memref<1x3x32xf32, 1>)
