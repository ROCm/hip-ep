...
module {
  ...
  func.func @reduce_mean_static_last_axis(
    ...
    hip.reduce_mean(%ctx) ins(%input, %axes : memref<8x128x512xf16, 1>, memref<1xi64, 1>)
  ...
  func.func @reduce_mean_dynamic(
    ...
    hip.reduce_mean(%ctx) ins(%input, %axes : memref<?x?x512xf16, 1>, memref<1xi64, 1>)
  ...
  func.func @reduce_mean_strided_channel_axis(
    ...
    hip.reduce_mean(%ctx) ins(%input, %axes : memref<4x8x3x5xf16, 1>, memref<1xi64, 1>)
