...
//    axes_num_elem, data_type, keepdims, noop_with_empty_axes) -> i32.
// ============================================================================
...
module {
  ...
  func.func @reduce_prod_static(
    ...
    hip.reduce_prod(%ctx) ins(%data, %axes : memref<3x2x2xf32, 1>, memref<1xi64, 1>)
  ...
  func.func @reduce_prod_dynamic(
    ...
    hip.reduce_prod(%ctx) ins(%data, %axes : memref<?x2x?xf32, 1>, memref<1xi64, 1>)
