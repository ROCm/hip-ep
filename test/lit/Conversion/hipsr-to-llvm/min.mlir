...
// CHECK-NEXT:  %[[TENSOR_OP:.*]] = llvm.mlir.constant(2 : i64) : i64
...
func.func @min(%ctx: !hipsr.context,
               %lhs: memref<4x1024xf16, #hipsr.mem<device>>,
               %rhs: memref<1024xf16, #hipsr.mem<device>>,
               %init: memref<4x1024xf16, #hipsr.mem<device>>) {
  hipsr.min(%ctx) ins(%lhs, %rhs : memref<4x1024xf16, #hipsr.mem<device>>, memref<1024xf16, #hipsr.mem<device>>)
