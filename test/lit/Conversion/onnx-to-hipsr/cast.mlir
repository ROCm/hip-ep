...
// CHECK-NEXT: return %[[SECOND]] : tensor<?x8xf32>
// CHECK-NEXT: }
...
// CHECK-SAME: %[[CTX:.+]]: !hipsr.context, %[[INPUT:.+]]: tensor<?x8xf32>) -> tensor<*xf16> {
// CHECK-NEXT: %[[RESULT:.+]] = "onnx.Cast"(%[[INPUT]]) : (tensor<?x8xf32>) -> tensor<*xf16>
// CHECK-NEXT: return %[[RESULT]] : tensor<*xf16>
// CHECK-NEXT: }
func.func @cast_unranked_result(
    %ctx: !hipsr.context, %input: tensor<?x8xf32>) -> tensor<*xf16> {
  %result = "onnx.Cast"(%input) : (tensor<?x8xf32>) -> tensor<*xf16>
