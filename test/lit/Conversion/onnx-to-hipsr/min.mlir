...
// CHECK-SAME:    %[[A:[^:]*]]: tensor<4x1024xf16, #hipsr.mem<device>>,
// CHECK-SAME:    %[[B:[^:]*]]: tensor<4x1024xf16, #hipsr.mem<device>>) -> tensor<4x1024xf16, #hipsr.mem<device>> {
...
// CHECK-SAME:    %[[CTX:[^:]*]]: !hipsr.context,
// CHECK-SAME:    %[[A:[^:]*]]: tensor<4x1024xf16, #hipsr.mem<device>>,
// CHECK-SAME:    %[[B:[^:]*]]: tensor<4x1024xf16, #hipsr.mem<device>>,
// CHECK-SAME:    %[[C:[^:]*]]: tensor<4x1024xf16, #hipsr.mem<device>>) -> tensor<4x1024xf16, #hipsr.mem<device>> {
...
// CHECK-SAME:    %[[CTX:[^:]*]]: !hipsr.context,
// CHECK-SAME:    %[[A:[^:]*]]: tensor<4x1024xf16, #hipsr.mem<device>>) -> tensor<4x1024xf16, #hipsr.mem<device>> {
...
// CHECK-SAME:    %[[CTX:[^:]*]]: !hipsr.context,
// CHECK-SAME:    %[[A:[^:]*]]: tensor<?x1024xf16, #hipsr.mem<device>>,
// CHECK-SAME:    %[[B:[^:]*]]: tensor<1024xf16, #hipsr.mem<device>>) -> tensor<?x1024xf16, #hipsr.mem<device>> {
