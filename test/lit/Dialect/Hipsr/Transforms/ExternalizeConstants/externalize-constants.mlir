...
// CHECK: hipsr.constant {index = 0 : i64, offset = 0 : i64, size = 16 : i64, value = dense<[1.000000e+00, 2.000000e+00, 3.000000e+00, 4.000000e+00]> : tensor<4xf32>} : tensor<4xf32, #hipsr.mem<device>>
...
// CHECK: hipsr.constant {index = 0 : i64, offset = 0 : i64, size = 16 : i64, value = dense_resource<"file|w.bin|100"> : tensor<2xi64>} : tensor<2xi64, #hipsr.mem<device>>
...
// CHECK: hipsr.constant {index = 0 : i64, offset = 0 : i64, size = 16 : i64, value = dense_resource<"file|w.bin|0"> : tensor<2xi64>} : tensor<2xi64, #hipsr.mem<device>>
// CHECK: hipsr.constant {index = 1 : i64, offset = 64 : i64, size = 8 : i64, value = dense<[5.000000e+00, 6.000000e+00]> : tensor<2xf32>} : tensor<2xf32, #hipsr.mem<device>>
...
// CHECK: hipsr.constant {index = 1 : i64, offset = 64 : i64, size = 8 : i64, value = dense<[7.000000e+00, 8.000000e+00]> : tensor<2xf32>} : tensor<2xf32, #hipsr.mem<device>>
...
// CHECK: hipsr.constant {index = 0 : i64, offset = 0 : i64, size = 16 : i64, value = dense<{{.*}}> : tensor<4xf32>} : tensor<4xf32, #hipsr.mem<device>>
