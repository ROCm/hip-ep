...
// CHECK-NEXT:      hipsr.preserve_shape %[[SHAPE]], %[[MATMUL]] : tensor<128x512xf16, #hipsr.mem<device>>
...
// CHECK-NEXT:      hipsr.preserve_shape %[[SHAPE]], %[[ADD]] : tensor<?x?x64xf16, #hipsr.mem<device>>
