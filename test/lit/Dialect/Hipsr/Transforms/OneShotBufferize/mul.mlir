...
// CHECK-NEXT: hipsr.mul(%[[CTX]]) ins(%[[LHS]], %[[RHS]] : memref<4x1024xf16, #hipsr.mem<device>>, memref<1024xf16, #hipsr.mem<device>>)
// CHECK-SAME: outs(%[[OUT]] : memref<4x1024xf16, #hipsr.mem<device>>)
// CHECK-NEXT: return %[[OUT]] : memref<4x1024xf16, #hipsr.mem<device>>
// CHECK-NEXT: }
func.func @mul_static(%ctx: !hipsr.context,
  ...
  %0 = hipsr.mul(%ctx) ins(%lhs, %rhs : tensor<4x1024xf16, #hipsr.mem<device>>, tensor<1024xf16, #hipsr.mem<device>>)
...
// CHECK-NEXT: hipsr.mul(%[[CTX]]) ins(%[[LHS]], %[[RHS]] : memref<?x1024xf16, #hipsr.mem<device>>, memref<1024xf16, #hipsr.mem<device>>)
// CHECK-SAME: outs(%[[OUT]] : memref<?x1024xf16, #hipsr.mem<device>>)
// CHECK-NEXT: return %[[OUT]] : memref<?x1024xf16, #hipsr.mem<device>>
// CHECK-NEXT: }
func.func @mul_dynamic(%ctx: !hipsr.context,
  ...
  %0 = hipsr.mul(%ctx) ins(%lhs, %rhs : tensor<?x1024xf16, #hipsr.mem<device>>, tensor<1024xf16, #hipsr.mem<device>>)
