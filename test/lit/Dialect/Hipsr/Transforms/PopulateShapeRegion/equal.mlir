...
// The region broadcasts the two operand shapes. The mask element type has no
// part in it.
// CHECK-LABEL: func.func @equal_normal(
...
func.func @equal_normal(
    %ctx: !hipsr.context, %lhs: tensor<?x1024xi64, #hipsr.mem<device>>,
