...
// Test BiasGelu E2E full pipeline
// This IR represents a com.microsoft.BiasGelu operation imported via onnx-mlir
//
// Verifies the complete hipdnn-pipeline:
// 1. convert-onnx-to-hip: onnx.Custom(BiasGelu) -> hip.bias_gelu
...
// CHECK: llvm.func @wrap_bias_gelu
