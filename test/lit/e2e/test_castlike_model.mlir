...
// It reuses the existing Cast (hip.cast → wrap_cast) infrastructure entirely;
// no new Hip op, HipToLLVM lowering, or runtime function is needed.
//
// Verifies the complete hipdnn-pipeline:
// 1. convert-onnx-to-hip: onnx.CastLike → hip.cast (reuses Cast path)
