...
// 3. convert-hip-to-llvm: hip.conv -> wrap_conv_forward_dispatch (the
//    runtime-selectable shim that picks miopen or ck per HIPDNN_EP_CONV)
// 4. generate-interface: Create inference_init/compute/cleanup/metadata

// CHECK: module attributes {
// CHECK-SAME: hipdnn.input_count = 1
// CHECK-SAME: hipdnn.output_count = 1
// CHECK: llvm.func @wrap_conv_forward_dispatch
