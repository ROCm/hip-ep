...
//   - NO output staging calls: prepare_output / finalize_output do not exist
//     (the output buffer is EP-owned and written in place).
// ============================================================================

// RUN: hip-mlir-opt %s --hipdnn-pipeline 2>&1 | FileCheck --implicit-check-not="llvm.call @hipdnn_ep_tensor_prepare_output" --implicit-check-not="llvm.call @hipdnn_ep_tensor_finalize_output" %s
