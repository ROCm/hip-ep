...
// pads are routed to host via hip.transfer: the pipeline lowers that to the
// pageable host pool + an async D2H + a plain stream sync (NOT the internal
// wrap_pad D2H that the old runtime did).
// CHECK-DAG: llvm.func @hipdnn_ep_get_host_mem_base
