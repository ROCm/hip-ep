...
// Test Reciprocal E2E full pipeline
// This IR represents an ONNX Reciprocal operation imported via onnx-mlir
// The model has one onnx.Reciprocal with f16 tensors
//
// Verifies the complete hipdnn-pipeline:
// 1. convert-onnx-to-hip: onnx.Reciprocal → hip.reciprocal
...
// CHECK: llvm.func @wrap_reciprocal
...
module {
  func.func @main_graph(%arg0: tensor<1x128x512xf16> {onnx.name = "input"}) -> (tensor<1x128x512xf16> {onnx.name = "output"}) {
    %0 = "onnx.Reciprocal"(%arg0) {onnx_node_name = "reciprocal_node"} : (tensor<1x128x512xf16>) -> tensor<1x128x512xf16>
