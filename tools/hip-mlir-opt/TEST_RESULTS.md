...
- **udna-opt tool**: Builds without errors
...
**Command:**
```bash
udna-opt test.mlir --convert-hip-to-llvm
```
...
This is the standard way to use MLIR passes in production code. Command-line tools like udna-opt are primarily for development/debugging.
