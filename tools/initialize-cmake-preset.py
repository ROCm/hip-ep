...
config = {
    ...
    "configurePresets": [
        {
            "name": "morphizen-demo debug",
            "description": "Default configuration for moprhizen demo",
            "generator": "Visual Studio 17 2022",
            "binaryDir": (VAI_RT_BUILD_DIR / "morphizen-demo").as_posix(),
            "cacheVariables": {
        ...
        },
        {
            ...
            "description": "Ninja",
            "generator": "Ninja",
            "binaryDir": (VAI_RT_BUILD_DIR / "morphizen-demo.ninja").as_posix(),
            "cacheVariables": {
                "CMAKE_EXPORT_COMPILE_COMMANDS": "ON",
                "CMAKE_MSVC_RUNTIME_LIBRARY": "MultiThreaded$<$<CONFIG:Debug>:Debug>",
                "Protobuf_DEBUG": "ON",
