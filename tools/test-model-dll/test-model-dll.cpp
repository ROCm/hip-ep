...
// Generate test data (fill byte buffer with sequential pattern)
void generateTestData(void* data, size_t sizeBytes) {
...
// Validate output buffer (check for NaN/Inf)
...
int main(int argc, char** argv) {
  ...
  for (size_t i = 0; i < input_shapes.size(); i++) {
    ...
    generateTestData(buffer.data(), sizeBytes);
